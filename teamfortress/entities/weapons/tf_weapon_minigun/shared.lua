...
local function DoBarrelRotation(ent, mat)
	TempAngle.y = 0
	if ent.LeviathanBarrelFix then
		TempAngle.p = 1.15
		TempAngle.r = -1.2
		mat:Rotate(TempAngle)
	else
		TempAngle.p = 0
		TempAngle.r = 0
	end
		
	TempAngle.y = ent.MinigunEntity.BarrelAngle
	TempAngle.p = -TempAngle.p
	TempAngle.r = -TempAngle.r
